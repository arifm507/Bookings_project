...
class RoutesTest < ApplicationSystemTestCase
  ...
  test "creating a Route" do
    ...
    fill_in "Arrival time", with: @route.arrival_time
    fill_in "Departure time", with: @route.departure_time
    fill_in "Destination", with: @route.destination
    fill_in "Duration", with: @route.duration
    fill_in "Number of seats", with: @route.number_of_seats
    fill_in "Origin", with: @route.origin
    fill_in "Travel date", with: @route.travel_date
